...
-- URL ใหม่ที่เข้ารหัส XOR (ไฟล์ JSON บน GitHub)
local _E1 = {107,85,101,68,106,91,70,70,70,111,96,101,67,101,100,100,70,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96}
local _E2 = {107,85,101,68,106,91,70,70,70,111,96,101,67,101,100,100,70,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96,107,101,99,101,101,100,96,101,103,96,69,69,69,96,96,96,96,96}
    ...
    Btn.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            ...
            if not entry.active then
                SL.Text = "คีย์ถูกปิดใช้งาน" SL.TextColor3 = Color3.fromRGB(255,80,80) return
            end
            local hwid = _getHWID()
...
PlayerTab:Toggle({Title = "สั่นไหว (คนอื่นเห็น)", Desc = "ทำให้ตัวละครสั่นไหวบนหน้าจอคนอื่น", Default = false, Callback = function(state)
