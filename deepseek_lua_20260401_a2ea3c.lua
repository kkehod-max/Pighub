...
task.spawn(function()
    ...
    if _ktype == "admin" then
        ...
        LogoutBtn.BackgroundColor3 = Color3.fromRGB(128,0,80)
        ...
        LogoutBtn.MouseButton1Click:Connect(function()
            ...
            _showKey(function(t, e)
                ...
                task.spawn(function()
                    ...
                    KF2.BackgroundColor3 = Color3.fromRGB(15,10,25)
                    ...
                    task.spawn(function()
                        ...
                        while KG2 and KG2.Parent do
                            t2 = t2 + 0.01
                            KS2.Color = Color3.fromHSV(0.75,0.6,1)
                            if _kexp == nil then
                                KL2.Text = _typeLabel(_ktype).." | ∞"
                                KL2.TextColor3 = Color3.fromRGB(150,100,255)
                            else
                                ...
                                KL2.TextColor3 = rem < 3600 and Color3.fromRGB(255,150,50) or Color3.fromRGB(150,100,255)
                            end
                            task.wait(1)
                        end
                    end)
...
-- ตั้งค่า Background ให้เป็นสีดำ/ม่วง
pcall(function()
...
-- แก้ไขระบบ ESP ชื่อให้เห็นทุกคน
...
RunService.Heartbeat:Connect(function()
    ...
    for player,espData in pairs(PlayerNameESP) do
        ...
        -- อัปเดต character และ hrp ถ้ามีการเปลี่ยนแปลง
        ...
        -- แสดงชื่อทุกคนที่อยู่ในกล้อง ไม่จำกัดระยะ
...
-- แก้ไขระบบไอเทมบนพื้นให้ไม่ปิดหน้าจอและแสดงได้ปกติ
...
-- ระบบเงินธนาคารสีม่วงสลับอ่อน-เข้ม
task.spawn(function()
    local hue = 0.75
