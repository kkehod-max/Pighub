...
PlayerTab:Toggle({Title = "ป้องกันการมอง (Anti Look)", Default = false, Callback = function(state) toggleFullAntiLook(state) end})
PlayerTab:Toggle({Title = "โหมดสุ่ม", Default = false, Callback = function(state) toggleRandomPattern(state) end})
PlayerTab:Slider({Title = "ความแรง", Step = 100, Value = {Min = 500, Max = 5000, Default = 2500}, Callback = function(v) setShakeStrength(v) end})
PlayerTab:Toggle({Title = "ระบบบิดตัว", Default = false, Callback = function(state) toggleBodyTwist(state) end})
PlayerTab:Toggle({Title = "ระบบ Ghost Shake", Default = false, Callback = function(state) toggleGhostShake(state) end})
