...
local function saveSettings()
    ...
    pcall(function()
        writefile(SettingsFile, game:GetService("HttpService"):JSONEncode(settingsToSave))
    end)
end
...
-- ============================================
-- ระบบ Server Hopper + Auto Rejoin
-- ============================================
...
local function setupAutoRejoin()
    ...
    RejoinConnection = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(state)
...
-- ============================================
-- ระบบ Auto Loot (ดูดของอัตโนมัติ)
-- ============================================
...
KeyManagementTab:Button({Title = "เปลี่ยนคีย์ (Logout)", Desc = "ล้างคีย์ปัจจุบันและกลับไปหน้าป้อนคีย์ใหม่", Callback = function()
    pcall(function() writefile("phs.txt", "") end)
    game:GetService("Players").LocalPlayer:Kick("กำลังเปลี่ยนคีย์ กรุณาใส่คีย์ใหม่")
end})
...
KeyManagementTab:Button({Title = "รีเซ็ตคีย์ทั้งหมด", Desc = "ล้างข้อมูลคีย์และตั้งค่าทั้งหมด", Callback = function()
    ...
    game:GetService("Players").LocalPlayer:Kick("รีเซ็ตคีย์และตั้งค่าเรียบร้อย")
end})
...
-- Visual Tab (Chams, Tracers, Skeleton)
...
-- Apply callbacks for toggles that need to run
